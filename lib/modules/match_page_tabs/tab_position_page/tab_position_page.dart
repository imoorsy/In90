                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    columns: <DataColumn>[
                      ...
                      DataColumn(
                        label: Text('points',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.green[700]),),
                      ),
                      DataColumn(
                        label: Text('P'),
                      ),
                    ...
                    rows: cubit.leaguePosition!.response!.first.league!.standings!.map(
                        ...
                        DataCell(Text(item.points.toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: Colors.green[700]),)),
